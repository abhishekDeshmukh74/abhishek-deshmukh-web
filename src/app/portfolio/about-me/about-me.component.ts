...
export class AboutMeComponent implements OnInit {
  ...
  jobs: IJob[] = [
    ...
    },
    {
      ...
      description:
        'API development for web app using nodeJs & Front-end development with Angular with SQL server',
    ...
    },
    {
      ...
      description:
        'Front end applications development in ReactJS for various banking use cases and API development in Java',
